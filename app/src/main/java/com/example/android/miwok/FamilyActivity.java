...
public class FamilyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        words.add(new Word("daughter", "Töchter", R.drawable.family_daughter));
        words.add(new Word("older brother", "älterer Bruder", R.drawable.family_older_brother));
        ...
        words.add(new Word("younger sister", "jüngere Schwester", R.drawable.family_younger_sister));
